...
def crawl(url: str, base: str, visited: Set[str] = None, finetuning: bool = False) -> Set[str]:
    """
    ...
    Args:
        ...
        finetuning (bool): Whether or not to stop crawling after 20 pages. Defaults to False.
...
def get_all_pages(url: str, finetuning: bool = False) -> List[str]:
    """
